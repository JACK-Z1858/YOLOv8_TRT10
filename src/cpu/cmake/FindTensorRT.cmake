...
if(NOT Tensor_nvinfer_plugin_LIBRARY)
    foreach(search ${_TensorRT_SEARCHES})
        find_library(Tensor_nvinfer_plugin_LIBRARY
...
# 检查是否找到库和头文件，并设置 TensorRT_FOUND 变量
...
if(TensorRT_FOUND)
    ...
    if(NOT TensorRT_LIBRARIES)
        ...
        if(Tensor_nvinfer_plugin_LIBRARY)
            list(APPEND TensorRT_LIBRARIES ${Tensor_nvinfer_plugin_LIBRARY})
        endif()
    endif()
    ...
    if(NOT TARGET TensorRT::nvinfer)
        ...
        # windows需要指定.dll（动态链接库），否则会链接到.lib（导入库），导致运行时找不到dll
        if (WIN32)
            foreach(search ${_TensorRT_SEARCHES})
